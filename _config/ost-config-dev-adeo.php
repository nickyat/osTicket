...
define('SECRET_SALT','141M9WoJJoZbeBIqmPnSu9lXchRhVyAd');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','y@adeo.pro');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','dev.db.adeo.pro');
define('DBNAME','sdesk_adeo');
define('DBUSER','sdesk');
define('DBPASS','sdesk');
